...
We found that this approach significantly improves the F1 score compared to a standard baseline (simple BERT fine-tuning).

*Further details can be found in the associated paper (pending acceptance).*
